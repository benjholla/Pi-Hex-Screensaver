...
namespace Screensavers
{
	...
	public abstract class Screensaver
	{
		...
		{
            //I added this to try to stop the program from running in preview mode
            //and running before the user would typically wish it to
		...
		protected virtual void ShowSettingsDialog()
		{
            ...
            PiHexScreensaver.Settings form = new PiHexScreensaver.Settings();
            //form.SetDesktopBounds(50, 50, 50, 50);
			...
			MessageBox.Show(sw.ToString(), "PiSaver", MessageBoxButtons.OK);
            */
		}
